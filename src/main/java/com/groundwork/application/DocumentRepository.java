...
public class DocumentRepository {
    ...
    public List<DocumentChunk> searchVectorOnly(String queryText, int limit) {
        // Query pgvector cosine distance or fallback text match if vector indexing is mock/testing
        String sql = """
    ...
    public List<DocumentChunk> searchKeywordOnly(String queryText, int limit) {
        String sql = """
